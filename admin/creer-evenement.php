        ...
        <form method="POST" enctype="multipart/form-data">
            <div
                ...
                <div style="grid-column: 1 / -1;">
                    ...
                    <input type="text" name="nom" required placeholder="Ex: Festival International d'Abidjan 2026"
                ...
                <div style="grid-column: 1 / -1;">
                    <label
                        ...
                        détaillée</label>
                    <textarea name="description" rows="4" placeholder="Artistes invités, déroulé du spectacle, accès..."
                        style="width: 100%; padding: 0.65rem 0.85rem; border: 1px solid var(--dash-border); border-radius: 8px; font-size: 0.85rem; font-family: inherit; box-sizing: border-box;"></textarea>
                </div>
                ...
                <div>
                    ...
                    <div id="box_custom_cat" style="display: none; margin-top: 6px;">
                ...
                <div
                        ...
                        <div>
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px;">
                                <label id="label_admin_salle_connue" onclick="setAdminSalleConnue(true)"
                                    style="display: flex; align-items: center; gap: 8px; padding: 0.58rem 0.8rem; border: 1.5px solid var(--dash-primary); background: #FFF2ED; border-radius: 8px; cursor: pointer; transition: all 0.2s;">
                                    <input type="radio" name="salle_connue" value="oui" checked
                                        style="accent-color: var(--dash-primary); margin: 0;">
                                ...
                                <label id="label_admin_salle_inconnue" onclick="setAdminSalleConnue(false)"
                                    style="display: flex; align-items: center; gap: 8px; padding: 0.58rem 0.8rem; border: 1px solid #E5E5E5; background: #ffffff; border-radius: 8px; cursor: pointer; transition: all 0.2s;">
                                    <input type="radio" name="salle_connue" value="non"
                                        style="accent-color: var(--dash-primary); margin: 0;">
                                    ...
                                    ?>
                                        <optgroup label="Salles (<?php echo htmlspecialchars($vName); ?>)">
                                            <?php foreach ($items as $sItem): ?>
                                                <option value="<?php echo htmlspecialchars($sItem['nom']); ?>">
                    ...
                    <div id="section_admin_salle_inconnue"
                        style="display: none; background: #FFF2ED; border: 1px solid #E5E5E5; border-radius: 10px; padding: 0.85rem 1rem;">
                        ...
                        <select name="statut_salle_inconnue"
                            ...
                            <option value="Lieu secret (bientôt dévoilé)">🤫 Lieu secret (dévoilé aux inscrits par
                                SMS/Email)</option>
                ...
                <div>
                    <label
                        style="display: block; font-size: 0.82rem; font-weight: 700; margin-bottom: 4px; color: var(--dash-text);">Affiche
                        de l'événement</label>
                ...
                <div>
                    <label
                        style="display: block; font-size: 0.82rem; font-weight: 700; margin-bottom: 4px; color: var(--dash-text);">Statut
                        initial</label>
                    <select name="statut"
                        style="width: 100%; padding: 0.65rem 0.85rem; border: 1px solid var(--dash-border); border-radius: 8px; font-size: 0.85rem; font-weight: 700; box-sizing: border-box; background: #ffffff;">
                ...
                <div>
                    ...
                    <select name="type_vote"
                        ...
                        <option value="realisation">Réalisation directe (vote d'appréciation)</option>
                    </select>
                </div>
                ...
                <div>
                    <label
                        ...
                        du Vote (FCFA)</label>
                    <input type="number" name="prix_vote" value="0" min="0" step="50" placeholder="0 = Gratuit"
                        style="width: 100%; padding: 0.65rem 0.85rem; border: 1px solid var(--dash-border); border-radius: 8px; font-size: 0.85rem; box-sizing: border-box;">
                </div>

                <div>
                    <label
                        style="display: block; font-size: 0.82rem; font-weight: 700; margin-bottom: 4px; color: var(--dash-text);">Taux
                        de Commission Plateforme (%)</label>
