...
<div class="page-header">
    <div class="page-heading">
        ...
        <p>Cet outil synchronise la table des places physiques avec les quantités de billets définies dans les types de
            tickets. Utile après la création d'un événement.</p>
    </div>
</div>
...
<div class="content-section" style="max-width: 800px; margin: 0 auto;">
    <div
        style="background: #F5F5F5; border: 1px solid var(--line); border-radius: 16px; padding: 2.5rem; box-shadow: var(--shadow-md); text-align: center;">
        <div
            style="width: 64px; height: 64px; background: #FFF2ED; color: var(--primary); border-radius: 50%; display: grid; place-items: center; font-size: 1.5rem; margin: 0 auto 1.5rem;">
        ...
        <p style="color: var(--muted); margin-bottom: 2rem; line-height: 1.6;">
            L'outil va parcourir tous vos types de billets et créer les entrées correspondantes dans la table
        ...
        <div
            style="display: flex; justify-content: center; gap: 2rem; flex-wrap: wrap; margin-bottom: 2rem; font-size: 0.9rem;">
            <div><strong style="font-size: 1.3rem; color: var(--navy);"><?php echo $nb_types; ?></strong><br><span
                    style="color: var(--muted);">Types de billets</span></div>
            <div><strong style="font-size: 1.3rem; color: var(--navy);"><?php echo $nb_attendu; ?></strong><br><span
                    style="color: var(--muted);">Places attendues</span></div>
            <div><strong
                    style="font-size: 1.3rem; color: <?php echo $nb_places >= $nb_attendu ? '#FF4A0D' : '#FF4A0D'; ?>;"><?php echo $nb_places; ?></strong><br><span
                    style="color: var(--muted);">Places en base</span></div>
        </div>

        <form method="POST">
            <button type="submit" name="generate" class="btn-submit"
                style="width: auto; padding: 1rem 2.5rem; font-size: 1.1rem; background: var(--primary);"
                onclick="return confirm('Générer les places manquantes pour tous les types de billets ?');">
